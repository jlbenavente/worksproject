...
# end
  ...
  joboffers = Joboffer.create!(
    [
      ...
      {title: 'Bailarin', user: usuario, description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit quia libero velit voluptatibus qui perspiciatis', skill: habilidad, location: ubicacion , conversation: conversacion, photo: 'https://rastro.com/images/13sq69lgumsv15eavhddst3gp4_2017042606224859010fa818823.jpg'},
